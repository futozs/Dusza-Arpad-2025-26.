...
import { UserListClient } from "@/app/jatekmester/users/UserListClient";
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-zinc-800 border border-zinc-700 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-zinc-400 text-sm">Játékmesterek</p>
                </div>
                <p className="text-3xl font-bold text-white">
                  {users.filter((u) => u.role === "JATEKMESTER").length}
                </p>
              </div>
              <div className="bg-zinc-800 border border-zinc-700 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
