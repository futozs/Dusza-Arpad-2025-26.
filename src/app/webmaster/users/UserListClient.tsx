...
export function UserListClient({ initialUsers, currentUserId }: Props) {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      const res = await fetch(`/api/webmaster/users?id=${selectedUser.id}`, {
        method: "PATCH",
  ...
  const handleDeleteUser = async (user: User) => {
    ...
    try {
      const res = await fetch(`/api/webmaster/users?id=${user.id}`, {
        method: "DELETE",
      });
                ...
                <>
                  ...
                  <Field>
                    ...
                    >
                      ...
                      <option value="WEBMASTER">🛡️ Webmester</option>
                    </select>
