...
export function JatekmesterLoginForm() {
  ...
  const onSubmit = async (data: SignInInput) => {
    try {
      ...
      if (result?.error) {
        ...
        // TODO: Session ellenőrzés hogy tényleg JATEKMESTER-e
        router.push("/jatekmester");
        router.refresh();
      }
    } catch (error) {
      console.error("Jatekmester login error:", error);
