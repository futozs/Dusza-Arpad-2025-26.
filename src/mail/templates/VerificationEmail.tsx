  ...
  return (
    <Html>
      ...
      <Body className="bg-zinc-950 font-sans">
        <Container className="mx-auto my-12 max-w-xl rounded-2xl border-2 border-purple-500/30 bg-linear-to-br from-zinc-900 to-zinc-950 p-8 shadow-2xl">
          {/* Header */}
          <Section className="text-center mb-8">
            <Heading className="m-0 text-5xl font-bold bg-linear-to-r from-purple-300 via-violet-300 to-fuchsia-300 bg-clip-text text-transparent">
              {company}
            </Heading>
          ...
          <Section>
            ...
            <Section className="text-center my-10">
              <Button
                ...
                className="inline-block rounded-xl bg-linear-to-r from-purple-500 via-violet-500 to-fuchsia-500 px-10 py-4 text-lg font-bold text-white shadow-2xl transition-all hover:from-purple-600 hover:via-violet-600 hover:to-fuchsia-600"
              >
